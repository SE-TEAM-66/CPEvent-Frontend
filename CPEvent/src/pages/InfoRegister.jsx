...
export default function InfoRegister() {
  return (
    <div>
      <div class="min-w-screen min-h-screen bg-baseblue-300 flex items-center justify-center px-5 py-5">
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl max-w-5xl overflow-hidden">
