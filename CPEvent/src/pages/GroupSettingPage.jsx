...
export default function GroupSettingPage() {
  ...
  return !isLoading ? (
    <div className="text-center">
      ...
      />
      <div className="flex flex-col pt-7 h-8 p-7 sm:p-0 sm:pt-7 ">
        <div className="sm:mx-40 md:mx-52 lg:mx-64 pb-24">
          <div>
            <p className="font-poppin font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl  md:text-left sm:text-center">
              {groupInfo.Topic}
            </p>
            <div className="font-poppin text-sm pt-2 flex flex-col md:flex-row justify-between items-center">
